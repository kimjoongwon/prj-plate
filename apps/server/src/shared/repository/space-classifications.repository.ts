...
export class SpaceClassificationsRepository {
	...
	async create(args: Prisma.SpaceClassificationCreateArgs): Promise<SpaceClassification> {
	...
	async upsert(args: Prisma.SpaceClassificationUpsertArgs): Promise<SpaceClassification> {
		this.logger.debug(`SpaceClassification 업서트 중...`);
		const result = await this.prisma.spaceClassification.upsert(args);
		return plainToInstance(SpaceClassification, result);
	}

	async update(args: Prisma.SpaceClassificationUpdateArgs): Promise<SpaceClassification> {
		this.logger.debug(`SpaceClassification 업데이트 중...`);
		const result = await this.prisma.spaceClassification.update(args);
		return plainToInstance(SpaceClassification, result);
	}

	async updateMany(args: Prisma.SpaceClassificationUpdateManyArgs): Promise<Prisma.BatchPayload> {
		this.logger.debug(`SpaceClassification 다중 업데이트 중...`);
		return await this.prisma.spaceClassification.updateMany(args);
	}

	async delete(args: Prisma.SpaceClassificationDeleteArgs): Promise<SpaceClassification> {
		this.logger.debug(`SpaceClassification 삭제 중...`);
		const result = await this.prisma.spaceClassification.delete(args);
		return plainToInstance(SpaceClassification, result);
	}

	async findMany(args: Prisma.SpaceClassificationFindManyArgs): Promise<SpaceClassification[]> {
	...
	async findFirst(args: Prisma.SpaceClassificationFindFirstArgs): Promise<SpaceClassification> {
		this.logger.debug(`SpaceClassification 최초 조회 중...`);
		const result = await this.prisma.spaceClassification.findFirst(args);
		return plainToInstance(SpaceClassification, result);
	}

	async findUnique(args: Prisma.SpaceClassificationFindUniqueArgs): Promise<SpaceClassification> {
	...
	async createManyAndReturn(args: Prisma.SpaceClassificationCreateManyArgs): Promise<SpaceClassification[]> {
		this.logger.debug(`SpaceClassification 다중 생성 중...`);
		const result = await this.prisma.spaceClassification.createManyAndReturn(args);
		return result.map((item) => plainToInstance(SpaceClassification, item));
	}

	async deleteMany(args: Prisma.SpaceClassificationDeleteManyArgs): Promise<Prisma.BatchPayload> {
