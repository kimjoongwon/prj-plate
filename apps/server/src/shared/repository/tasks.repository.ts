...
export class TasksRepository {
	...
	async updateMany(args: Prisma.TaskUpdateManyArgs): Promise<Prisma.BatchPayload> {
	...
	async deleteMany(args: Prisma.TaskDeleteManyArgs): Promise<Prisma.BatchPayload> {
