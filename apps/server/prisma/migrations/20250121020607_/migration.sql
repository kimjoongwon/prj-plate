/*
  ...
  - The values [WEEK,MONTH,YEAR] on the enum `RepeatCycleTypes` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RepeatCycleTypes_new" AS ENUM ('WEEKLY', 'MONTHLY', 'YEARLY');
...
-- AlterTable
ALTER TABLE "Session" ALTER COLUMN "repeatCycleType" DROP NOT NULL,
ALTER COLUMN "repeatCycleType" DROP DEFAULT;
