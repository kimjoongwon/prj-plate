...
//        }
    ...
    public void onAuthenticated() {
        Drawable ic_fingerprint_success_id = this.getResources().getDrawable(R.drawable.ic_fingerprint_success);
        this.mFingerprintImage.setImageDrawable(ic_fingerprint_success_id);
        this.mFingerprintSensorDescription.setText("지문이 인식되었습니다.");
        this.mFingerprintSensorDescription.setTextColor( getResources().getColor(R.color.success_color));
        this.isAuthInProgress = false;
    ...
    public void onError(String errorString, int errorCode) {
        ...
        Drawable ic_fingerprint_error_id = this.getResources().getDrawable(R.drawable.ic_fingerprint_error);
        this.mFingerprintSensorDescription.setTextColor( getResources().getColor(R.color.warning_color));
//        this.mFingerprintError.setText(errorString);
        this.mFingerprintImage.setImageDrawable(ic_fingerprint_error_id);
        this.mFingerprintSensorDescription.setText(errorString);
        this.mFingerprintSensorDescription.setTextColor(Color.RED);
    }
