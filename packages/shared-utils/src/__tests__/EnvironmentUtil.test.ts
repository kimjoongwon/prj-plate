...
describe("EnvironmentUtil", () => {
  ...
  describe("getConfigByEnvironment", () => {
    it("개발 환경에서 개발용 설정을 반환해야 함", () => {
      ...
      expect(EnvironmentUtil.getConfigByEnvironment(configs)).toBe("dev-config");
    });
    ...
    it("스테이징 환경에서 스테이징용 설정을 반환해야 함", () => {
      ...
      expect(EnvironmentUtil.getConfigByEnvironment(configs)).toBe("staging-config");
    });
    ...
    it("운영 환경에서 운영용 설정을 반환해야 함", () => {
      ...
      expect(EnvironmentUtil.getConfigByEnvironment(configs)).toBe("prod-config");
    });
