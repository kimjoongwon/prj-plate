...
export const apkInstaller = {
   ...
   * @return {void}
   */
  installApp: function (packagePath: string) {
   ...
   */
  uninstallApp: function (packageName: string) {
   ...
   */
  isAppInstalled: function (packageName: string, cb: any) {
   ...
   */
  getAppVersion: function (packageName: string, cb: any) {
   ...
   * @return {void}
   */
  runApp: function (packageName: string) {
