...
export const createUserAssociation = (
  createUserAssociationDto: BodyType<CreateUserAssociationDto>,
  options?: SecondParameter<typeof customInstance>,
) => {
  return customInstance<CreateUserAssociation200AllOf>(
    {
      url: `http://localhost:3005/api/v1/admin/users/associations`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const getCreateUserAssociationMutationOptions = <
  TError = ErrorType<void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof createUserAssociation>>,
    TError,
    { data: BodyType<CreateUserAssociationDto> },
    TContext
  >;
  request?: SecondParameter<typeof customInstance>;
}): UseMutationOptions<
...
> => {
  ...
  > = props => {
    ...
    return createUserAssociation(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type CreateUserAssociationMutationResult = NonNullable<
  Awaited<ReturnType<typeof createUserAssociation>>
>;
export type CreateUserAssociationMutationBody =
  BodyType<CreateUserAssociationDto>;
export type CreateUserAssociationMutationError = ErrorType<void>;

export const useCreateUserAssociation = <
  TError = ErrorType<void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  const mutationOptions = getCreateUserAssociationMutationOptions(options);
...
export const getSessionsByQuery = (
  ...
  return customInstance<GetSessionsByQuery200AllOf>(
    { url: `http://localhost:3005/`, method: 'GET', params, signal },
    options,
  );
};
...
export const updateTemplate = (
  ...
  return customInstance<UpdateTemplate200AllOf>(
    {
      url: `http://localhost:3005/${templateId}`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const removeSessions = (
  ...
  return customInstance<RemoveSessions200AllOf>(
    {
      url: `http://localhost:3005/removedAt`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const updateTimelineItem = (
  ...
  return customInstance<UpdateTimelineItem200AllOf>(
    {
      url: `http://localhost:3005/${timelineItemId}`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const removeTimelineItem = (
  ...
  return customInstance<RemoveTimelineItem200AllOf>(
    {
      url: `http://localhost:3005/${timelineItemId}/removedAt`,
      method: 'PATCH',
    },
    options,
  );
...
export const updateSubjectById = (
  ...
  return customInstance<UpdateSubjectById200AllOf>(
    {
      url: `http://localhost:3005/${subjectId}`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const updateSession = (
  ...
  return customInstance<UpdateSession200AllOf>(
    {
      url: `http://localhost:3005/${sessionId}`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
...
export const getAppBuilder = (
  ...
  return customInstance<unknown>(
    {
      url: `http://localhost:3005/api/v1/admin/app-builder`,
      method: 'GET',
      signal,
    },
    options,
