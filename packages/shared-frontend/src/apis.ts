...
export const getGetAllServiceResponseMock = (
  ...
  Array.from(
    ...
    name: faker.helpers.arrayElement([
      faker.helpers.arrayElement(['userService', 'settingService'] as const),
      undefined,
    ]),
    updatedAt: {},
    ...overrideResponse,
...
export const getGetAllServiceMockHandler = (
  ...
  return http.get('*/api/v1/admin/services', async () => {
    ...
    return new HttpResponse(
      JSON.stringify(
        overrideResponse ? overrideResponse : getGetAllServiceResponseMock(),
      ),
      {
        status: 200,
        headers: {
